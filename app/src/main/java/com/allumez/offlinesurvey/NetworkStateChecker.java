...
//       int a = new MainActivity().deleteNames();
        ...
        if (activeNetwork != null)
        {
            ...
            if (activeNetwork.getType() == ConnectivityManager.TYPE_WIFI || activeNetwork.getType() == ConnectivityManager.TYPE_MOBILE)
            {
                ...
                if (cursor.moveToFirst()) {
                    do {
                        //calling the method to save the unsynced names to MySQL
                        saveName(
                                ...
                                cursor.getBlob(cursor.getColumnIndex(DatabaseHelper.COLUMN_PHOTO))
                        );
     ...
     * names that is to be saved and id of the names from SQLite
     * if the names is successfully sent
     * we will update the status as synced in SQLite
     * */
    private void saveName(final int id, final String name,final String phone,final String address,final byte[] image)
    {
                ...
                })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError
            {
                ...
                params.put("image", Base64.encodeToString(image, Base64.DEFAULT));
